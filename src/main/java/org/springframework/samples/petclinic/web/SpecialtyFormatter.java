...
/**
 * Instructs Spring MVC on how to parse and print elements of type 'Specialty'. Starting
...
public class SpecialtyFormatter implements Formatter<Specialty> {
	...
	@Override
	public String print(final Specialty petType, final Locale locale) {
		return petType.getName();
	}

	@Override
	public Specialty parse(final String text, final Locale locale) throws ParseException {
		Collection<Specialty> findSpecialtys = this.clinicService.findAllSpecialties();
